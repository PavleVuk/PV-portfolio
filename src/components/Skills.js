        ...
        <center>
          <div className="skills">
            ...
            I am mostly front-end oriented, but I did few back-end projects too. </p>*/}
             {/*} <h1> About me</h1>
              <p>
                Hello, I am Pavle, a student of Master Informational Technology
                who loves technology, computers, smartphones and everything
                about it. I love programming, both front-end and back-end. As a
                student, I am trying to learn as much as I can and get some
                coding knowledge.
          </p>*/}
              ...
              <div className="languages">
                ...
                <div className="lang">
                  <img src={Less} alt="Less logo" height="60" />
                  Less&nbsp;
                </div>
                <div className="lang">
                  <img
